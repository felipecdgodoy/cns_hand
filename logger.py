...
class CSVLogger():
    ...
    def final(self, best_accuracy_list, final_accuracy_list, best_epoch_list, avg_valid_acc_50_list, acc_each_class_list, acc_each_dataset_list=None):
        writer = csv.writer(self.csv_file)
        best_accuracy_list.insert(0, 'best acc')
        final_accuracy_list.insert(0, 'final acc')
        best_epoch_list.insert(0, 'best epoch')
        avg_valid_acc_50_list.insert(0, 'avg_valid_acc_50')
        ...
        writer.writerow(avg_valid_acc_50_list)
